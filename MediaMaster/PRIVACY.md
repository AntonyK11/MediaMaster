...
+ **Developer** (referred to as either "the Developer", "We", "Us" or "Our" in this Agreement) refers to MediaMaster App's owner.
+ **Service** refers to the MediaMaster App software.
...
Usage Data is never collected when using the Service.
...
+ By email: akonstantas@bluewin.ch